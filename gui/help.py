...
def show_help_dialog(parent):
    """
    Display the LOOK-DGC help dialog.
    parent: The parent QMainWindow instance
    """
    ...
    # QTextBrowser for rich HTML content
    ...
    <p><b>Full Documentation:</b> 
       <a href="https://github.com/Gooichand/LOOK-DGC">GitHub Repository</a></p>
